...
private static String TAG = "ReviewAsyncTask";
/*private RecyclerView mRecycler;


    public ReviewAsyncTask(RecyclerView recycler){
        mRecycler=recycler;
    }*/
...
protected void onPostExecute(JSONArray result){
       ...
       Bus eB = App.getInstance().getEventBus();
        eB.register(this);
        eB.post(new BeefEvent.ReviewSyncComplete(result));
        eB.unregister(this);

    //mRecycler.setAdapter(new ReviewRecyclerAdapter(result));
